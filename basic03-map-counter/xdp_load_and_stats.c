			...
			struct stats_record *stats_prev)
{
	...
	double period;
	__u64 packets, bytes; /* Assignment#1: Add byte counters */
	double pps; /* packets per sec */
	double bps; /* bits per sec */ /* Assignment#1 */
...
/* Assignment#3: Add function to read percpu array */
...
static bool map_collect(int fd, __u32 map_type, __u32 key, struct record *rec)
{
	...
	case BPF_MAP_TYPE_PERCPU_ARRAY:
		map_get_value_percpu_array(fd, key, &value); /* Assignment#3 */
		break;
	default:
